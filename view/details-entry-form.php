                        ...
                        <div class="container">
                            <form id="application-form" class="well">
                                <div class="form-group">
                                    ...
                                    <div class="form-row">
                                        <div class="col">
                                            <p><strong>ID/NRC</strong>&nbsp;<span class="text-danger">*</span></p><input class="form-control" type="text" required="" name="" placeholder="Ex. 1234/2/1">
                                        </div>
                                ...
                                <div class="form-group">
                                    <p><strong>Number&nbsp;</strong><span class="text-danger">*</span></p><input class="form-control" type="number" name="" placeholder="7777777777">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <br>
                                    <p><strong>License&nbsp;</strong><span class="text-danger">*</span></p><input class="form-control" type="text" required="" name="" placeholder="">
                                    <p><strong>Year Of License&nbsp;</strong><span class="text-danger">*</span></p>
                                </div>
                                <div class="form-group">
                                    <div class="form-row">
                                        <div class="col"><input class="form-control" type="text" required="" name="" placeholder="">
                                            <p><strong>Class&nbsp;</strong><span class="text-danger">*</span></p> <select id="country" name="country" class="form-control">
                                        ...
                                        <div class="col"><input class="form-control" type="text" required="" name="" placeholder="">
                                            <p><strong>Other Class</strong> <span class="text-danger">*</span></p>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="form-row">
                                        <div class="col"><input class="form-control" type="text" required="" name="" placeholder="">
                                            <p>Next of Kin&nbsp;*</p><input class="form-control" type="number" required="" name="" placeholder="">
                                            <p>Contact</p>
                                        </div>
                                        <div class="col"><input class="form-control" type="text" required="" name="" placeholder="">
                                            <p>Relationship</p>
